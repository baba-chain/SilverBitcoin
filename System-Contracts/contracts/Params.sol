...
contract Params {
    ...
    uint256 public constant BronzeValidatorStaking = 1000 ether;      // 1,000 SBTC
    uint256 public constant SilverValidatorStaking = 10000 ether;     // 10,000 SBTC
    uint256 public constant GoldValidatorStaking = 100000 ether;      // 100,000 SBTC
    uint256 public constant PlatinumValidatorStaking = 1000000 ether; // 1,000,000 SBTC
